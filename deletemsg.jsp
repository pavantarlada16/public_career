...
<% 
int msgid=Integer.parseInt(request.getParameter("mid"));
Connection con=null;
...
try{
    ...
    pst=con.prepareStatement("delete from messages where msgid=?");
    pst.setInt(1,msgid);
    int rows=pst.executeUpdate();

    if(rows>0){
        out.println("Message deleted successfylly");
    }
    else{
        out.println("The Message you are trying to delete is not existed in database");
    }
